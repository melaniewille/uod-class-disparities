## VisionTransformer Classification Model for Imbalanced DUO Subsets
...
CHECKPOINTS_PATH = os.path.join(project_root, "classification_study", "VisionTransformer", "checkpoints", "checkpoints_imbalanced")
os.makedirs(CHECKPOINTS_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "classification_study", "cls_results", "VisionTransformer", "imbalanced")
...
if __name__ == '__main__': 
    ...
    for data_dir in dataset_variations:  # Loop over datasets
        ...
        # Initialize W&B
        wandb.init(
            project=f"classification_imbalanced",                  
            name=f"{run_name}",                         
            config={                                    
                "optimizer": "Adam",
