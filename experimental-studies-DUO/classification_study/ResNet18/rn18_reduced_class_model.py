## ResNet18 Classification Model for Reduced DUO Subsets
...
CHECKPOINTS_PATH = os.path.join(project_root, "classification_study", "ResNet18", "checkpoints", "checkpoints_one_class_reduced")
os.makedirs(CHECKPOINTS_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "classification_study", "cls_results", "ResNet18", "one_class_reduced")
