## ResNet18 Classification Model for DUO with Weighted Sampling
...
CHECKPOINTS_PATH = os.path.join(project_root, "classification_study", "ResNet18", "checkpoints", "checkpoints_weighted")
os.makedirs(CHECKPOINTS_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "classification_study", "cls_results", "ResNet18", "weighted")
...
if __name__ == '__main__': 
    ...
    for data_dir in dataset_variations:  # Loop over datasets
        ...
        # Modify the last fully connected layer for 4-class classification
