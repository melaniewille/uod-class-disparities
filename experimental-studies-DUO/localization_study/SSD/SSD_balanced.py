...
BASE_PATH = os.path.join(project_root, "localization_study", "loc_datasets", "balanced_data")
CHECKPOINT_PATH = os.path.join(project_root, "localization_study", "SSD", "checkpoints", "checkpoints_balanced")
os.makedirs(CHECKPOINT_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "localization_study", "loc_results", "SSD", "balanced")
os.makedirs(RESULTS_PATH, exist_ok=True)

CLASS_LIST = ["echinus", "holothurian", "starfish"]
