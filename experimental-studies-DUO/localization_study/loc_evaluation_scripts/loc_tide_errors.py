...
# for limited scallop comment out the above starting from CLASS_LIST
# for model in MODELS:
#         gt_file = f"{BASE_PATH}/loc_evaluation_scripts/ground_truths/ground_truth_test_scallop.json"
#         if not os.path.exists(gt_file):
#             print(f"Missing GT file: {gt_file}")
#             continue
#         pred_file = f"{RESULTS_PATH}/{model}/single_class/limited_scallop/predictions.json"
#         if not os.path.exists(pred_file):
#             print(f"Missing prediction file for limited scallop")
#             continue
#         out_dir = f"{RESULTS_PATH}/{model}/single_class/limited_scallop/TIDE"
#         tag = f"{model}_single_class_limited_scallop"
#         print(f"Running: {tag}")
#         run_tide_evaluation(gt_file, pred_file, tag, out_dir)
#     print("All TIDE evaluations completed.")