## MobileNetV2 Classification Model for Imbalanced DUO Subsets
...
CHECKPOINTS_PATH = os.path.join(project_root, "classification_study", "MobileNetV2", "checkpoints", "checkpoints_imbalanced")
os.makedirs(CHECKPOINTS_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "classification_study", "cls_results", "MobileNetV2", "imbalanced")
