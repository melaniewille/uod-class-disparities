## MobileNetV2 Classification Model for DUO with Weighted Sampling
...
CHECKPOINTS_PATH = os.path.join(project_root, "classification_study", "MobileNetV2", "checkpoints", "checkpoints_weighted")
os.makedirs(CHECKPOINTS_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "classification_study", "cls_results", "MobileNetV2", "weighted")
