## VisionTransformer Classification Model for Balanced DUO Subsets
...
BASE_PATH = os.path.join(project_root, "classification_study", "cls_datasets", "balanced_data")
CHECKPOINTS_PATH = os.path.join(project_root, "classification_study", "VisionTransformer", "checkpoints", "checkpoints_balanced")
os.makedirs(CHECKPOINTS_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "classification_study", "cls_results", "VisionTransformer", "balanced")
...
dataset_variations = [
    f"{BASE_PATH}/full_balanced",
    f"{BASE_PATH}/0.9_balanced_data",
    f"{BASE_PATH}/0.8_balanced_data",
    f"{BASE_PATH}/0.7_balanced_data",
    f"{BASE_PATH}/0.6_balanced_data",
    f"{BASE_PATH}/0.5_balanced_data",
    f"{BASE_PATH}/0.4_balanced_data",
    f"{BASE_PATH}/0.3_balanced_data",
]
...
if __name__ == '__main__': 
    ...
    for data_dir in dataset_variations:  # Loop over datasets
        ...
        # Initialize W&B
        wandb.init(
            project=f"classification_balanced",                  
            name=f"{run_name}",                         
            config={                                    
                "optimizer": "Adam",
        ...
        print("Loading pre-trained Vision Transformer (ViT-B/16)")
        ...
        # Testing best acc models
        for checkpoint in ["best_acc"]: 
