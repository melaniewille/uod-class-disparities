## VisionTransformer Classification Model for Reduced DUO Subsets
...
CHECKPOINTS_PATH = os.path.join(project_root, "classification_study", "VisionTransformer", "checkpoints", "checkpoints_one_class_reduced")
os.makedirs(CHECKPOINTS_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "classification_study", "cls_results", "VisionTransformer", "one_class_reduced")
