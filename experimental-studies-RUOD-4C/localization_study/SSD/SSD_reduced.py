...
CHECKPOINT_PATH = os.path.join(project_root, "localization_study", "SSD", "checkpoints", "checkpoints_reduced")
os.makedirs(CHECKPOINT_PATH, exist_ok=True)
RESULTS_PATH = os.path.join(project_root, "localization_study", "loc_results", "SSD")
os.makedirs(RESULTS_PATH, exist_ok=True)


REDUCTION_FACTORS = ["0.75", "0.5", "0.25"]
CLASS_LIST = ["echinus", "holothurian", "starfish", "scallop"]
...
for reduction in REDUCTION_FACTORS:
    for class_name in CLASS_LIST:
        TRAIN_IMG_DIR = os.path.join(BASE_PATH, f"{reduction}_labels", class_name, "images/train")
        TRAIN_LABEL_DIR = os.path.join(BASE_PATH, f"{reduction}_labels", class_name, "labels/train")
        VAL_IMG_DIR = os.path.join(BASE_PATH, f"{reduction}_labels", class_name, "images/valid")
        VAL_LABEL_DIR = os.path.join(BASE_PATH, f"{reduction}_labels", class_name, "labels/valid")
        TEST_IMG_DIR = os.path.join(BASE_PATH, f"{reduction}_labels", class_name, "images/test")
        TEST_LABEL_DIR = os.path.join(BASE_PATH, f"{reduction}_labels", class_name, "labels/test")
        ...
        class_results_path = os.path.join(RESULTS_PATH, f"{reduction}_reduced", class_name)
